...
PROMPT="You are an independent runtime verifier giving a cross-model attestation. Someone claims this repository's current working tree makes a specific behavior true. Prove or refute it by running the real thing — you did not build it and have no stake in it passing.
...
Surface (how to reach the running thing): $SURFACE
