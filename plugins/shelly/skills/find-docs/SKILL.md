...
name: find-docs
description: >-
  Fetches current, authoritative docs, API references, config options, and
  examples for any library, framework, SDK, API, CLI tool, or cloud service.
  Use whenever writing or debugging code against an external technology,
  or answering "how do I" / version-specific questions — even for well-known
  tools, since model knowledge may be stale.
---
