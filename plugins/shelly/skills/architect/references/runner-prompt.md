...
- Encode invariants in types: hard-to-misuse types beat runtime checks, and runtime checks beat prose comments.
...
You are one of several runners, each independent. Produce the best design you can; don't hedge against the others. Differences between candidates are the signal used to pick a base and graft. Converging on a safe-looking middle defeats the exploration.
